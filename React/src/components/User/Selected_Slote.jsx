    ...
    return (
        <>
            ...
            <div className="max-w-lg mx-auto px-4 pt-4">
                ...
                >
                    <FaArrowLeft className="mr-2 text-xl sm:text-base" />{" "}
                    {/* Larger on mobile */}
                    <span className="hidden sm:inline">Back to Results</span>
                </button>
            </div>

            <div className="max-w-lg mx-auto p-6 mt-10 bg-gray-900 text-white rounded-lg shadow-lg">
